...
class Department(BaseModel):
    ...
    """
    logger.info('Department: Note the class definition')
...
class Job(BaseModel):
    ...
    logger.info('Which Department does this job belong to ')    
    department_employed = ForeignKeyField(Department, null = False)
